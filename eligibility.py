...
def var_pensionara_atlaide(vecums, ir_seniors):
    """
    Pārbauda, vai persona saņem pensionāra atlaides.

    Args:
        vecums (int): Personas vecums.
        ir_seniors (bool): Vai persona ir senioirs.

    Returns:
        bool: True, ja saņem pensionāra atlaides, pretējā gadījumā False.
    """
    return vecums >= 65 or ir_seniors
...
if __name__ == "__main__":
    try:
        ...
        while True:
            atbilde = input("Vai esat seniors? (jā/nē): ")
            if ir_deriga_atbilde(atbilde):
                ir_seniors = parse_ja_ne(atbilde)
                break
            else:
                print("Ievadi lūdzu korektu atbildi!")
        ...
        if var_pensionara_atlaide(vecums, ir_seniors):
...
if __name__ == "__main__":
    try:
        ...
        print("Lūdzu, ievadiet derīgu skaitli vecumam.")
>>>>>>> d9a41b4966ee25839806f6f380f7e892465b0885
