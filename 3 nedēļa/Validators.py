...
def is_phone_number(phone):
    """Pārbauda, vai tālruņa numurs ir derīgs (8 cipari)."""
    if phone.isdigit() and len(phone) == 8:
        return True
    return False
def is_lv_phone_valid(phone):
    """
    ...
    Example:
        >>> is_lv_phone_valid('+37112345678')
        True
        >>> is_lv_phone_valid('0037112345678')
        True
        >>> is_lv_phone_valid('12345678')
        False
    """
...
def is_strong_password(password):
    """Pārbauda, vai parole ir stipra (vismaz 8 simboli, lielie un mazie burti, cipari)."""
    if len(password) < 8:
        return False
...
def is_valid_date(date_str):
    """Pārbauda, vai datums ir derīgs (formāts DD/MM/YYYY)."""
    try:
...
if __name__ == "__main__":
    ...
    print("Email valid (test@example.com):", is_email("test@example.com"))
    print("Email valid (invalid):", is_email("invalid"))

    # Test phone validation (8 digits)
    print("Phone valid (12345678):", is_phone_number("12345678"))
    print("Phone valid (1234):", is_phone_number("1234"))

    # Test Latvian phone validation 
    print("LV phone valid (+37112345678):", is_lv_phone_valid("+37112345678"))
    print("LV phone valid (0037112345678):", is_lv_phone_valid("0037112345678"))
    print("LV phone valid (12345678):", is_lv_phone_valid("12345678"))
    print("LV phone valid (+3711234567):", is_lv_phone_valid("+3711234567"))
